    ...
    <div class="bg-slate-900 text-white py-12 border-b border-slate-800">
        <div class="max-w-6xl mx-auto px-6 lg:px-12">
            <nav class="flex items-center gap-2 text-xs font-mono text-emerald-400 mb-4">
                ...
                <span>/</span>
                <span class="text-slate-300">Kesehatan</span>
            </nav>
            <h1 class="font-display text-3xl sm:text-4xl font-bold tracking-tight">Fasilitas &amp; Layanan Kesehatan</h1>
            <p class="text-slate-300 text-sm sm:text-base mt-2 max-w-2xl leading-relaxed">
                Pusat perawatan medis, UGD 24 jam, jejaring poskesdes dan posyandu yang melayani masyarakat Lamasi.
            </p>
        </div>
    </div>
